  ...
  <div class="user-conter">
    <div class="user-message">
      <ul>
        ...
        <li v-show="!showLoadding&&(!data.pageContents||data.pageContents.length==0)" style="text-align: center; padding: 30px">
          暂无站内消息
        </li>
      </ul>
...
<script>
  ...
  import pagingBy from "pc/components/paging-by";
  import loadding from "pc/components/loadding";
  export default {
    data() {
      return {
        active:-1,
