        ...
        <div class="registerbox-content">
          <div class="form-box">
            <div class="form-group">
              ...
              <input type="text" class="ps-input ps-input1" v-model="registerForm.account" placeholder="用户名(6-10位数字或字母)" maxlength="20">
            </div>
            <div class="form-group">
              <i class="iconay ay-mima3"></i>
              <input ref="pwd" type="password" autocomplete="off" class="ps-input inpt-pwd" v-model="registerForm.password" placeholder="密   码(6-16位数字和字母）"
                maxlength="16">
