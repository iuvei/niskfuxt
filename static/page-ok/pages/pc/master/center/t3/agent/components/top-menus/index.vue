<template>
  <div v-if="isAgent" class="mainDev content">
    ...
    data() {
      return {
        ...
        gamebox:[
            ...
            {name:'申请提款',routerName:'agent_drawmoney'},
            {name:'站内信',routerName:'agent_message'},
            // {name:'绑定银行卡/折号',routerName:'agent_banks'},
        ],
      };
    },
    props: {},
...
<style lang="scss" scoped>
    .mainDev{
        ...
        .gameDev{
            ...
            &.active {
                border-bottom: 3px solid #e2b85a;
                ...
                .triangle-right{
                    ...
                    height: 0;
                    border: 10px solid;
                    border-color: #e2b85a transparent transparent transparent;
                }
            }
        }
        .gameDev:nth-child(9){
