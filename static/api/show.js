...
const $allGamesDataPc = 'https://www.staticsources.com/slot/aoying/allGames.json' // 获取游戏大厅列表pc
const $allGamesDataMobile = 'https://www.staticsources.com/slot/aoying/allPhoneGames.json' // 获取游戏大厅列表mobile
