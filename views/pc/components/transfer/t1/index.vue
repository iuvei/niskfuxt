    ...
    <div class="transfer-info">
      <div class="transfer-main">
        ...
        <Form :model="data" ref="transferForm" :label-width="110" class="transfer-form" v-if="selectPlatform.value!='DEPUTY'">
          ...
          <!-- 按钮 -->
          <FormItem>
            <Button class="submitbtn" @click="transfer(1)">主账户转入</Button>
            <Button class="submitbtn2" @click="transfer(2)">转出至主账户</Button>
          </FormItem>
        </Form>
        ...
        <Form :model="data" ref="transferForm" :label-width="110" class="transfer-form" v-if="selectPlatform.value=='DEPUTY'">
          ...
          <!-- 按钮 -->
          <FormItem>
            <Button class="submitbtn3" @click="transfer(3)">确认转入</Button>
          </FormItem>
        </Form>
      ...
      <Modal v-model="transferAll_Modal" width="360">
        ...
        <div slot="footer">
          <Button type="error" size="large" long :loading="transferAll_Post" @click="transferAll">提交</Button>
        </div>
      </Modal>
    </div>
</template>
