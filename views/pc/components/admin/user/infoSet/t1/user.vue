  ...
  <div class="form-rowbox perfect-data">
    ...
    >
      ...
      <FormItem label="微信号码" prop="wechat">
        <Input v-model="Data.wechat" :placeholder="userData.wechat?userData.wechat:'输入微信号码'"></Input>
      </FormItem>

      <FormItem label="Q Q号码" prop="qq">
        <Input v-model="Data.qq" :placeholder="userData.qq?userData.qq:'输入QQ号码'"></Input>
      </FormItem>
...
import { update } from "@@/mixins/user/update";
